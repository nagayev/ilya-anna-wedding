...
(function(e, t) {
    typeof exports == "object" && typeof module < "u" ? module.exports = t() : typeof define == "function" && define.amd ? define("uikitcircle", t) : (e = typeof globalThis < "u" ? globalThis : e || self,
    e.UIkitCircle = t())
}
)(this, (function() {
    "use strict";
    function e(t) {
        e.installed || t.icon.add({
            ...
            marker: '<svg width="14" height="14" viewBox="0 0 14 14"><line fill="none" stroke="#000" stroke-linecap="round" stroke-width="2" x1="7" y1="1" x2="7" y2="13"/><line fill="none" stroke="#000" stroke-linecap="round" stroke-width="2" x1="1" y1="7" x2="13" y2="7"/></svg>',
            ...
            "nav-parent-icon-large": '<svg width="14" height="14" viewBox="0 0 14 14"><polyline fill="none" stroke="#000" stroke-width="2" points="1 4 7 10 13 4"/></svg>',
            ...
            "slidenav-next": '<svg width="10" height="16" viewBox="0 0 10 16"><polyline fill="none" stroke="#000" stroke-linecap="round" stroke-width="2" points="2 14 8 8 2 2"/></svg>',
            "slidenav-next-large": '<svg width="12" height="18" viewBox="0 0 12 18"><polyline fill="none" stroke="#000" stroke-linecap="round" stroke-width="2" points="1 17 9 9 1 1"/></svg>',
            "slidenav-previous": '<svg width="10" height="16" viewBox="0 0 10 16"><polyline fill="none" stroke="#000" stroke-linecap="round" stroke-width="2" points="8 14 2 8 8 2"/></svg>',
            "slidenav-previous-large": '<svg width="12" height="18" viewBox="0 0 12 18"><polyline fill="none" stroke="#000" stroke-linecap="round" stroke-width="2" points="10 17 2 9 10 1"/></svg>',
    ...
    return typeof window < "u" && window.UIkit && window.UIkit.use(e),
    e
}
));
