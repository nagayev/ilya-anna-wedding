class AlertElement extends HTMLElement {
    ...
    attributeChangedCallback(t, o, e) {
        ...
        case "role":
            ...
            break;
        case "dismiss":
            (!e || e === "") && (!o || o === "") ? this.button && !this.hasAttribute("dismiss") ? this.destroyCloseButton() : !this.button && this.hasAttribute("dismiss") && this.createCloseButton() : this.button && e === "false" ? this.destroyCloseButton() : !this.button && e !== "false" && this.createCloseButton();
            break;
        case "close-text":
            (!e || e !== o) && this.button && this.button.setAttribute("aria-label", e);
            break;
        case "auto-dismiss":
            this.autoDismiss();
            break
    ...
    onMutation(t) {
        for (const o of t)
            o.type === "childList" && o.addedNodes.length && this.button && this.firstElementChild !== this.button && this.prepend(this.button)
    }
    close() {
...
;
Joomla.renderMessages = (s, t, o, e) => {
    const h = getMessageContainer(t);
    (typeof o > "u" || o && o === !1) && Joomla.removeMessages(h),
    Object.keys(s).forEach(i => {
        let n = i;
        const u = s[i]
          , a = document.createElement("joomla-alert");
        if (["success", "info", "danger", "warning"].indexOf(i) < 0 && (n = i === "notice" ? "info" : i,
        n = i === "message" ? "success" : n,
        n = i === "error" ? "danger" : n,
        n = i === "warning" ? "warning" : n),
        ...
        typeof Joomla.Text._(i) < "u") {
            const r = document.createElement("div");
            r.className = "alert-heading",
            r.innerHTML = Joomla.sanitizeHtml(`<span class="${i}"></span><span class="visually-hidden">${Joomla.Text._(i) ? Joomla.Text._(i) : i}</span>`),
            a.appendChild(r)
        }
...
Joomla.removeMessages = s => {
    getMessageContainer(s).querySelectorAll("joomla-alert").forEach(o => o.close())
}
,
